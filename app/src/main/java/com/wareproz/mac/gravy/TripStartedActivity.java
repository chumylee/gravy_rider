...
public class TripStartedActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, LocationListener, GoogleApiClient.OnConnectionFailedListener {

    TextView txtPickupAddress;
    String ride_id, pickup_gps, pickup_address, id, dropoff_gps, dropoff_name;
    Button navigate;
    ...
    public static final String TAG = TripStartedActivity.class.getSimpleName();
